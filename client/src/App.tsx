        ...
        <FeilGrense erInnsendingFeil={false}>
            ...
            <ApplicationProvider>
                <Routes>
                    ...
                    <Route path="/krav/oppsummering"
                           element={<SettTittel title="helmet.title.krav_oppsummering"><FeilGrense
                               erInnsendingFeil={true}><KravOppsummering/></FeilGrense></SettTittel>}/>
                    <Route path="/krav/kvittering"
                           element={<SettTittel title="helmet.title.krav_kvittering"><KravKvittering/></SettTittel>}/>
                    <Route path="/oversikt"
                           element={<SettTittel title="helmet.title.krav_oversikt"><Oversikt/></SettTittel>}/>
                    <Route path="/oversikt/:vedtakId"
                           element={<SettTittel title="helmet.title.kravdetaljer"><OversiktDetaljer/></SettTittel>}/>
                    <Route path="*"
