                                    ...
                                    return (
                                        <li key={idx} style={{margin: '0.5rem 0'}}>
                                            ...
                                            >
                                                ...
                                                {it.barnsNavn ?
                                                    <LinkPanel.Title
                                                        className="navds-heading--small"> {it.barnsNavn} </LinkPanel.Title>
                                                    : <LinkPanel.Title
                                                        className="navds-heading--small"> {it.barnsFnr} (fødselsnummer) </LinkPanel.Title>}

                                                {/* TODO: Følge designsystemet og ha svart overskrift som blir blå ved mouseOver? */}
                                                <LinkPanel.Description>
                                                    {t('oversikt.krav_beskrivelse_linje1')} <Dato verdi={it.opprettet}
                                                                                                  formatLong={true}></Dato>
                                                    <br/>
                                                    ...
                                                    {!it.slettet && it.utbetalingsdato && (
                                                        <div style={{marginTop: '0.5rem'}}>
                                                            <Tag variant="success" size="small">
                                                                {t('oversikt.utbetalt')} <Dato
                                                                verdi={it.utbetalingsdato}></Dato>
                                                            </Tag>
                                                        </div>
                                                    )}
