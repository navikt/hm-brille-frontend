        ...
        <KravSteg>
            ...
            {!harValgtVirksomhet ? (
                <Panel>
                    ...
                    <VirksomhetForm
                        tidligereBrukteVirksomheter={tidligereBrukteVirksomheter?.tidligereBrukteOrganisasjoner}/>
                </Panel>
            ) : (
                <>
                    <Bedrift orgnr={appState?.orgnr} orgNavn={appState?.orgNavn} orgAdresse={appState?.orgAdresse}
                             onByttBedrift={
                                 () => {
                                     setAppState((prev) => ({
                                         ...prev,
